...
;;; A terminal is a medium the widgets already knew how to draw on: a rule
;;; carries the glyph it is made of, a choice carries the two characters that
;;; mark it, and what is under the pointer is asked for by line and column. All
;;; this has to say is how wide a string is and where its characters go.
  ...
  (multiple-value-bind (fr fg fb br bg bb attr)
    ...
    (let* ((style (ui:style-of widget))
      ...
      (vt:make-face-attrs
       ...
       :underline (when (ui:underlinep widget) :single)
