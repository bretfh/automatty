...
(vtx/mode:define-mode prompt-mode ())
...
(vtx/mode:define-key 'prompt-mode "Down"     #'prompt-next)
(vtx/mode:define-key 'prompt-mode "C-n"      #'prompt-next)
(vtx/mode:define-key 'prompt-mode "Up"       #'prompt-previous)
(vtx/mode:define-key 'prompt-mode "C-p"      #'prompt-previous)
(vtx/mode:define-key 'prompt-mode "PageDown" #'prompt-page-down)
(vtx/mode:define-key 'prompt-mode "PageUp"   #'prompt-page-up)
(vtx/mode:define-key 'prompt-mode "Home"     #'prompt-first)
(vtx/mode:define-key 'prompt-mode "End"      #'prompt-last)
(vtx/mode:define-key 'prompt-mode "DEL"      #'prompt-rub-out)
(vtx/mode:define-key 'prompt-mode "C-u"      #'prompt-clear)
(vtx/mode:define-key 'prompt-mode "RET"      #'prompt-accept)
