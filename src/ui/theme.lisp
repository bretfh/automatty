...
(define-theme
  ...
  '((:default   :fg fg)
    ...
    (:field         :bg bg-alt)
    (:cursor        :fg fg :bold t)
    (:row-selected  :bg bg-active)
    (:card          :fg border)
    (:card-cursor   :fg fg :bold t)
    (:tab-active    :fg fg :bg bg-alt :bold t)
    (:toggle-on     :fg green :bg bg-active :bold t)
    (:tree          :fg fg-dim)
    (:find-hit      :fg bg :bg yellow-cooler)
    (:find-hit-current :fg bg :bg yellow :bold t)
    (:state-blocked-strong :fg yellow :bold t)
    (:scroll-track      :fg border)
    (:scroll-arrow      :fg fg)
    (:scroll-arrow-dim  :fg bg-active)
    (:scroll-thumb      :fg fg)
    (:scroll-thumb-back :fg yellow)
    (:spark-quiet       :fg bg-active)
    (:well              :bg bg-well)
